...
<main class="mian-layout">
    <div class="home">
        <div class="banner half" id="main-banner"><h1 class="title">你好，欢迎来到<?php $this->options->title(); ?></h1><div class="subtitle"><span class="text"><?php $this->options->description(); ?></span></div><i class="iconfont icon-up" hidden data-scroll-home></i></div>
