...
<main class="mian-layout"><div class="cat-or-tag"><div class="title"><h1 class="title-name">全部分类</h1><span class="title-num">分类总览 · <?php echo $categoryTotal; ?> 个分类</span></div><div class="type-lists"><?php echo $categoryList; ?></div></div>
