...
<main class="mian-layout"><div class="cat-or-tag"><div class="title"><h1 class="title-name">全部标签</h1><span class="title-num">标签总览 · <?php echo $tagTotal; ?> 个标签</span></div><div class="type-lists"><?php echo $tagList; ?></div></div>
